            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"><a href="{{route('Jurusan.index')}}">Detail</a>
                          </div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1"><a href="{{route('Jurusan.index')}}">Detail</div>
